...
jindo._p_._JINDO_IS_SP = /Version\/[\d\.]+\s(?=Safari)/.test(jindo._p_._j_ag);  // Safari
jindo._p_._JINDO_IS_CH = /Chrome\/[\d\.]+\sSafari\/[\d\.]+$/.test(jindo._p_._j_ag);  // Chrome
